        ...
        <form class="needs-validation" method="post" novalidate="" enctype="multipart/form-data">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="text" id="kode_pengguna" name="kode_pengguna" class="form-control" required="" value="<?= $pengguna->kode_pengguna ?>" placeholder="Kode Pengguna">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="nama" name="nama" class="form-control" required="" value="<?= $pengguna->nama ?>" placeholder="Nama">
                    <div class="invalid-feedback">
                        Masukkan Nama
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="email" name="email" class="form-control" required="" value="<?= $pengguna->email ?>" placeholder="Email">
                    <div class="invalid-feedback">
                        Masukkan Email
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <input type="text" id="telepon" name="telepon" class="form-control" required="" value="<?= $pengguna->telepon ?>" placeholder="Telepon">
                    <div class="invalid-feedback">
                        Masukkan Telepon
                    </div>
                </div>
