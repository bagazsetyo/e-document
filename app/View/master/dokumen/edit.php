        ...
        <form class="needs-validation" method="post" novalidate="" enctype="multipart/form-data">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="text" id="no_dokumen" name="no_dokumen" class="form-control" required="" value="<?= $dokumen->no_dokumen ?>" placeholder="No Dokumen">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="judul" name="judul" class="form-control" required="" value="<?= $dokumen->judul ?>" placeholder="Judul">
                    <div class="invalid-feedback">
                        Masukkan Judul
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <textarea name="deskripsi" class="form-control" id="deskripsi"><?= $dokumen->deskripsi ?></textarea>
                    <div class="invalid-feedback">
                        Masukkan Deskripsi
                    </div>
                </div>
